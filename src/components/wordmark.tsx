...
export function Wordmark({ className, color = "#2D6A4F" }: WordmarkProps) {
  ...
  return (
    <svg
      viewBox="-8 58 744 224"
      className={className}
      role="img"
      aria-label="SGHaus"
      style={{ color }}
    >
      <text x="0" y="214" style={letter} fill="currentColor">
        S
      </text>
      <g transform="translate(116 72) scale(0.3349)">
        <g transform="translate(-124 -61)">
          <path fillRule="evenodd" d={PIN_D} fill="currentColor" />
          <circle cx="337.1" cy="277" r="48" fill="#52B788" />
        </g>
      </g>
      <text x="250" y="214" style={letter} fill="currentColor">
        Haus
      </text>
    </svg>
  );
